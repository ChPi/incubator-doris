...
public:
    ...
    static FunctionPtr create() { return std::make_shared<FunctionJsonAlwaysNotNullable<SpecificImpl>>(); }
    ...
    static void execute(const std::vector<const ColumnString*>& data_columns,
                        ColumnString& result_column, size_t input_rows_count, const std::vector<const ColumnUInt8*> nullmaps) {
